...
Nothing here costs anything and nothing here commits anyone.

1. **Wolfgang speaks with the director** to find out whether the school is open to exploring this at all.
2. **An exploratory conversation**—the director, KA21 and Rizom, about an hour, at the school or online. Rizom leads; KA21 listens. The purpose is to understand the school's situation, its problems and its expectations. Nothing is proposed or sold.
3. **KA21 decides** whether the school is a suitable case and whether to commission the phase.

If the school is not the right case, what was prepared carries to the next lead in education.

## The phase, step by step

**Step 1 — Preparation with KA21.** Half a day, before the school is involved further. Together we define what makes a use case valuable and feasible in education, which questions to ask, what a Rizom Brain can and cannot do, and what a customer must be able to provide: people, knowledge, data, ownership, budget. Output: the first version of KA21's qualification guide.

**Step 2 — Interviews.** Five to eight one-to-one conversations with the school's staff, 45 minutes each, over one to two weeks. The director and whoever holds the practice: an administrator who has been there for years, a teacher who carries a subject or a year group, someone who joined recently enough to remember what was confusing. Each is asked what they know that nobody else does, and what goes wrong if they are not there tomorrow. KA21 facilitates in German; Rizom runs the method. After each interview, a short debrief between us: what we heard, what we should have asked, what it means for the next one.

**Step 3 — Workshop.** Half a day with the relevant staff at the school, facilitated by KA21; Rizom online or on site, by agreement. Together we draw the map: who knows what, whose judgment counts where, how information moves.

**Step 4 — Playbook and recommendation.** In the third week. The school receives the playbook. KA21 receives the assessment.

## What the school provides

- Willingness for one open conversation about its staff-side processes and problems.
- If the phase goes ahead: five to eight people for 45 minutes each, half a day for the workshop, and a room.
- No IT involvement, no system access, and no pupil data.

## What the school receives

The playbook: the map of where its knowledge sits and who it depends on, as it is today, with three to five interventions ranked by cost and impact. It is the school's to keep and act on, with or without any software. Nothing to install, nothing to license, nothing owed afterwards.

The playbook is the product. Organisations commission the Knowledge Session for it on its own; the school receives it at no cost.
...
None, on either side, at any step.

- The exploratory conversation does not commit KA21 to the phase.
...
The €5,000 stands on its own. If KA21 goes on to commission a build, it counts in full toward it.

## Afterwards

Two paths, decided together on the assessment:

- **The school is not the right case.** KA21 uses the qualification guide and the method on the next lead in education.
- **The school is a good case.** KA21 and Rizom agree to go on to the build: €10,000 for the remaining five months, ending with a working application—a Brain with an agent for the identified use case, tested with a real user—and the ability to run and redeploy it without Rizom. The €10,000 holds for a pilot of that shape; the playbook is what confirms it.

## Practical

- **Price:** €5,000 fixed, invoiced at commissioning.
