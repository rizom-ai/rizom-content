...
*Drafted 2026-08-09, redrafted 2026-09-07, updated 2026-09-15. The reusable shape for any organisation that wants to open a new vertical with a Brain application and become a certified delivery partner. Canonical text for the two-page PDF (rizom-innovation-lead-pilot.pdf). Pricing follows the published price bands in [[fundraising-strategy-and-decisions]]; partner economics follow [[certified-partner-model-decisions]]; the first step is the Knowledge Audit as sold in [[close-kit-knowledge-session]].*
