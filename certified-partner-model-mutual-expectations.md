# Certified Partner Model — Mutual Expectations

Companion to [[certified-partner-model-decisions]]. Drafted 2026-07-29. This outlines what a Rizom Certified Partner can expect of Rizom, and what Rizom expects of a partner — the substance behind the mark. Status: internal draft; becomes the basis of the partner agreement once the stichting is founded.

## What partners can expect of Rizom

**The mark and the registry.** A public listing in the certification registry — name, capability tags (facilitation · domain · implementation), standing (candidate → active → steward), and delivered engagements. The right to use the "Rizom Certified" marks while listed. The registry is the single source of truth; Rizom points clients at it.

**The methodology, kept current.** Access to the full delivery apparatus: the TMS methodology, the Survey → Workshop → Playbook engagement, proposal and contract templates, the Operator Playbook, and future playbooks as they ship. When the methodology changes, partners hear it first — before the public does.

**The tools, with no platform dependency.** The open-source Rizom Brains platform (AGPL core, Apache SDK), deployable end-to-end on the partner's own infrastructure and accounts. Certification never creates a technical dependency on Rizom: a partner who leaves the program keeps every capability except the mark.

**Co-delivery into competence.** The certifying engagement is co-delivered with Rizom, paid, on a real client. Rizom's obligation during it is transfer, not supervision: by the end, the partner can run the engagement alone. After certification, Rizom remains reachable for engagement-level consultation at agreed terms, not as an unpaid safety net and not as a required checkpoint.

**Lead flow, symmetric and honest.** When Rizom sources a client and hands delivery to a partner, the partner takes the 60% delivery share and Rizom the 15% acquisition share. Rizom routes work by registry standing and capability fit, and says so publicly. No promise of lead volume — the registry is young and demand is being built; anyone who promises guaranteed pipeline at this stage would be inventing evidence.
...
- **Not exclusivity.** Partners serve their own clients, keep their own brand, and may work with other methods and platforms outside the mark. Rizom certifies other partners in the same market.
- **Not employment or agency.** Partners are independent businesses; neither party contracts on the other's behalf.
